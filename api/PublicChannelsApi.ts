...
export class PublicChannelsApi {
    ...
    public getChannels (countryIsoCode: string, acceptEncoding: Array<string>, extraHttpRequestParams?: any ) : ng.IHttpPromise<models.ChannelInfoList> {
        const localVarPath = this.basePath + '/BeezUP/public_channels/2.0/{countryIsoCode}'
    ...
    /**
        ...
        * 
        */
    public getChannelsByCountry (extraHttpRequestParams?: any ) : ng.IHttpPromise<{ [key: string]: string; }> {
        const localVarPath = this.basePath + '/BeezUP/public_channels/2.0/';
