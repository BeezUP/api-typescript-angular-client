...
export class LOVApi {
    ...
    /**
        ...
        * 
        */
    public getPublicListNames (extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.BeezUPCommonLOVLink2>> {
        const localVarPath = this.basePath + '/v2/public/lov/';
    ...
    /**
        ...
        */
    public getPublicListOfValues (listName: string, acceptLanguage?: Array<string>, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<models.BeezUPCommonListOfValueItem>> {
        const localVarPath = this.basePath + '/v2/public/lov/{listName}'
